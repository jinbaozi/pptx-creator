...
Creative output passes only when deck score is at least 80, every slide is at least 70, slop risk is at most 20, P0/P1 findings are zero, and editability is at least L4. The proof must include a real LibreOffice render of every page and a complete contact sheet. Contextual checks come from the design read and dials. Explicit user brand and source intent override generic heuristics. Font compatibility is reported from real font preflight data.
