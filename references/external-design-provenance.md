...
The Creative Director Pipeline contains adapted protocols from the pinned
...
|---|---|---|
| [`leonxlnx/taste-skill@e988add20dab0fa97d7a76781c48961c8184288e`](https://github.com/leonxlnx/taste-skill/tree/e988add20dab0fa97d7a76781c48961c8184288e) | Context-first taste, explicit profile, bounded style dials, mechanical preflight | `deck.plan.json` context/design intent, contextual taste dials, calibrated anti-slop rules |
...
| [`hugohe3/ppt-master@de0af38a07706eee03b97f6186d8e0ffba595892`](https://github.com/hugohe3/ppt-master/tree/de0af38a07706eee03b97f6186d8e0ffba595892) | Rendered visual-review stages, hard/soft issue routing, bounded rollback | Browser HTML audit, post-render PPTX geometry audit, full-size per-slide Host review, bounded repair |
| [`anthropics/skills@b29e7cf65e5cb78a5ac33d582270551bc74a14eb`](https://github.com/anthropics/skills/tree/b29e7cf65e5cb78a5ac33d582270551bc74a14eb/skills/frontend-design) | Contextual frontend direction and anti-default visual choices | Inspiration for direction diversity and intentional composition only; no copied runtime or bundled dependency |

The requested name `front-design` did not resolve to a credible exact upstream.
The pinned Anthropic `frontend-design` skill is recorded only as the closest
traceable source; this repository does not claim they are the same project.
The Claude Design source identifies itself as reverse-engineered community work,
so its direction and polish sequence is treated as non-authoritative
inspiration rather than Anthropic product behavior.
