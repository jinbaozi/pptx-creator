...
function isolatedFixture() {
  ...
  fs.mkdirSync(join(fixtureRoot, "integration", "protocol"), { recursive: true });
  fs.copyFileSync(
    join(root, "integration", "protocol", "presentation-package.schema.json"),
    join(fixtureRoot, "integration", "protocol", "presentation-package.schema.json")
  );
  fs.mkdirSync(join(fixtureRoot, "integration", "scripts"), { recursive: true });
  fs.copyFileSync(
    join(root, "integration", "scripts", "validate-presentation-package.mjs"),
    join(fixtureRoot, "integration", "scripts", "validate-presentation-package.mjs")
  );
